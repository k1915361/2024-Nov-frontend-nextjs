        ...
        <nav className="navbar navbar-expand-lg">
            <div className="container-fluid gap-1">
                <div className="d-flex me-3">
                    <a href="/polls/home/" className="link-underline-dark link-underline-opacity-0">
                        <h4>
                            😊
                ...
                <form className="d-flex" role="search">
                    <div className="input-group ">
                        <div className="form">
                            <input type="search" id="form1" className="form-control border-1 shadow-sm" placeholder="Search models, datasets, users..."/>
                        </div>
                ...
                <div className="dropdown-center">
                    <button className="btn dropdown-toggle shadow-sm" type="button" data-bs-toggle="dropdown" aria-expanded="false">                      
                    ...
                    <ul className="dropdown-menu dropdown-menu-end">
                        <li>
                            <a href="/polls/home" className="dropdown-item">
                        ...
                        <li>
                            <a href="/polls/profile" className="dropdown-item">
                        ...
                        <li>
                            <a href="/polls/process-model-options/" className="dropdown-item">
                        ...
                        <li>
                            <a href="/polls/previous-tasks/" className="dropdown-item">
                        ...
                        <li>
                            <a href="/polls/personal-model-repo/" className="dropdown-item">
                        ...
                        <li>
                            <a href="/polls/personal-dataset-repo/" className="dropdown-item">
                        ...
                        <li>
                            <a href="/polls/upload-model/" className="dropdown-item">
                        ...
                        <li className="nav-item">
                            <a href="/polls/logout/" className="dropdown-item">
